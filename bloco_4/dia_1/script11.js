...
if(salarioBase <= 1903.98){
    ...
    ((salarioBruto - inss) * 0.275) - 869.36;
}

salarioLiquido = salarioBruto - inss - ir;
console.log("Salário Líquido: R$" + salarioLiquido);
salarioLiquido = salarioLiquido - (salarioBruto * 0.17);
console.log("Salário Líquido descontado pagamento da Trybe: R$" + salarioLiquido);