...
/*
07. Implemente uma função que adiciona uma tarefa personalizada ao calendário. A função deve receber como parâmetro
...
/*
Bônus: Vamos adicionar compromissos ao seu calendário? Implemente uma função que, ao digitar um compromisso
na caixa de texto "COMPROMISSOS", adiciona o item à lista "MEUS COMPROMISSOS" ao clicar no botão "ADICIONAR".
...
function addCompromissos() {
  ...
  let btnComp = document.querySelector('#btn-add');
  let taskbox = document.querySelector('#task-input');
  btnComp.addEventListener('click', addComp);
